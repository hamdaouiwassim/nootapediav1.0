                ...
                <tbody>
                    ...
                    @foreach ($posts as $p)
                        <tr>
                            ...
                            <td>
                                @if ($p->image)
                                    <img src="{{ asset('uploads/posts/images') }}/{{ $p->image }}"
                                        style="max-width: 100px;" alt="{{ $p->title }}" class="img-thumbnail">
                                @else
                                    غير متاحة
                                @endif
                            </td>
                            ...
                            <td>
                                <a class="btn btn-primary" href="{{ route('ShowDashboardPost', ['id' => $p->id]) }} "><i
                                        class="bi bi-eye"></i> </a>
                                        @if ($p->stat == "inreview" )
